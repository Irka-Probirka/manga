...
import {getChapterWithTitle, getGenreByTitleId, getHashtagById, getTeamById, getTitle} from "@/app/api/getAllData";
...
const Page = async ({params}) => {
    ...
    return (
        <ContainerWithBgImage bgLayer={title.backgroundLarge}>
            <div>
                <Image src={title?.backgroundLarge} alt={'Фотка комикса'} width={300} height={450} className={'rounded mb-2'}/>
